/**
 * @file boards\cy001\bsp\bsp_key2.c
 *
 * Copyright (C) 2022
 *
 * bsp_key2.c is free software: you can redistribute it and/or modify
...
#define CONFIG_GPIO_PIN             (LL_GPIO_PIN_2)
